...
import com.fmontiel.calificaciones.views.indexview.Formulario;
        ...
        jTable1.getColumnModel().getColumn(3).setCellEditor(new ButtonEditor(
                ...
                (JSONObject jo) -> {
                    ...
                    Formulario f = new Formulario(
                            ...
                            jo.getBigInteger("cui"),
                            jo.getString("nombres"),
                            jo.getString("apellidos"),
                            (JSONObject jo1) -> {
                    ...
                    try {
                        if (am.eliminarAlumno(new BigInteger(jo.getString("cui")))) {
                            actualizarListaAlumnos();
                            rellenarTabla();
                            JOptionPane.showMessageDialog(
                                    null,
                                    "Alumno eliminado con CUI: " + jo.getString("cui"),
                                    "Éxito",
